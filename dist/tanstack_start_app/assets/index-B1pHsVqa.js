import { x as getAugmentedNamespace, y as getDefaultExportFromCjs, e as commonjsGlobal } from "./server-C3eyQudk.js";
import require$$0$2 from "path";
import { EventEmitter } from "node:events";
import { Readable as Readable$1 } from "node:stream";
import { n as notImplemented } from "./worker-entry-i2qUKO6a.js";
...
class Worker extends EventEmitter {
  stdin = null;
  stdout = new Readable$1();
  stderr = new Readable$1();
  threadId = 0;
  ...
  getHeapSnapshot() {
    return Promise.resolve(new Readable$1());
  }
}
...
function requireSpawnWorker() {
  ...
  const { Worker: Worker2 } = require$$0$1;
  spawnWorker = ({ workerPath }) => new Worker2(workerPath);
  return spawnWorker;
}
var terminateWorker;
...
function requireLoadImage() {
  ...
  const fetch2 = commonjsGlobal.fetch || require$$2;

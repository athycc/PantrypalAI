export type Meal = {
  id: string;
  name: string;
  ingredients: string[]; // keywords matched against pantry names
  priceMin: number;
  priceMax: number;
  kcal: number;
  minutes: number;
  emoji: string;
  tipid: boolean; // budget-friendly
  steps: string[];
};
...
export const MEALS: Meal[] = [
  {
    ...
    priceMin: 45, priceMax: 52, kcal: 320, minutes: 30, emoji: "🍚", tipid: true,
  ...
  },
  {
    ...
    priceMin: 32, priceMax: 40, kcal: 280, minutes: 15, emoji: "🍳", tipid: true,
  ...
  },
  {
    ...
    priceMin: 55, priceMax: 70, kcal: 380, minutes: 20, emoji: "🥘", tipid: true,
  ...
  },
  {
    ...
    priceMin: 68, priceMax: 85, kcal: 420, minutes: 45, emoji: "🍲", tipid: false,
  ...
  },
  {
    ...
    priceMin: 28, priceMax: 38, kcal: 180, minutes: 10, emoji: "🥬", tipid: true,
  ...
  },
  {
    ...
    name: "Scrambled Eggs",
    ingredients: ["eggs"],
    priceMin: 18, priceMax: 25, kcal: 200, minutes: 5, emoji: "🍳", tipid: true,
  ...
  },
  {
    ...
    priceMin: 95, priceMax: 120, kcal: 520, minutes: 60, emoji: "🥩", tipid: false,
  ...
  },
  {
    ...
    priceMin: 25, priceMax: 35, kcal: 290, minutes: 25, emoji: "🍫", tipid: true,
    steps: ["Boil rice in water", "Add cocoa + sugar", "Simmer until thick"],
  },
];

export function matchScore(meal: Meal, pantryNames: string[]): { have: string[]; missing: string[]; pct: number } {
